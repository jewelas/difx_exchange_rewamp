  ...
  return (
    <Layout fill={fill} useDarkMode={useDarkMode} pathIndex={4}>
      ...
      >
        ...
        <path d="M11.375 8.66406V11.3724H1.625V8.66406H0V11.3724C0 11.8034 0.171205 12.2167 0.475952 12.5214C0.780698 12.8262 1.19402 12.9974 1.625 12.9974H11.375C11.806 12.9974 12.2193 12.8262 12.5241 12.5214C12.8288 12.2167 13 11.8034 13 11.3724V8.66406H11.375Z" fill="#2B2C3E"/>
        </svg>
    </Layout>
  );
}
