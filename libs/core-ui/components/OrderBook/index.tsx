...
export function OrderBook({
  ...
  const BidComponent = ({ layout = 'default', maxRow = (layout === 'compact' ? 15 : 12), hideColumns }: { layout?: string, maxRow?: number, hideColumns?: string[] }) => (
    <OrderData
      layout={layout}
  ...
  const AskComponent = ({ layout = 'default', maxRow = (layout === 'compact' ? 15 : 12), hideColumns = [] }: { layout?: string; maxRow?: number, hideColumns?: string[] }) => (
    <OrderData
      layout={layout}
      hideColumns={hideColumns}
      type="ask"
