...
function LayoutPro({theme}:{theme:string}) {
    return (
        <svg width="67" height="57" viewBox="0 0 67 57" fill="none">
            ...
            <rect x="51" y="6" width="12" height="46" fill={theme==='dark' ? "#161F30" : "#777"} />
            <rect x="4" y="16" width="12" height="36" fill={theme==='dark' ? "#161F30" : "#777"} />
            <rect x="49" y="6" width="8" height="31" transform="rotate(90 49 6)" fill={theme==='dark' ? "#161F30" : "#777"} />
            <rect x="16" y="6" width="8" height="12" transform="rotate(90 16 6)" fill={theme==='dark' ? "#161F30" : "#777"} />
